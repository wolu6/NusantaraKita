...
import DetailDataDesaKel from '@/components/DetailDataDesaKel.vue'

useHead({
  title: 'Data Desa/Kelurahan - Nusantara Kita',
  meta: [
    {
      name: 'description',
      content:
    ...
    { property: 'og:title', content: 'Data Desa/Kelurahan' },
    {
    ...
    {
      property: 'og:url',
      content: 'https://nusakita.yuefii.site/data-wilayah/desa-kelurahan'
    }
  ],
  link: [
    {
      rel: 'canonical',
      href: 'https://nusakita.yuefii.site/data-wilayah/desa-kelurahan'
    }
  ]
})
</script>
