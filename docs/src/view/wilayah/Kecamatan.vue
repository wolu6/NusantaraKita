...
import DetailDataKecamatan from '@/components/DetailDataKecamatan.vue'

useHead({
  title: 'Data Kecamatan - Nusantara Kita',
  meta: [
    {
      name: 'description',
      content:
    ...
    { property: 'og:title', content: 'Data Kecamatan' },
    {
    ...
    {
      property: 'og:url',
      content: 'https://nusakita.yuefii.site/data-wilayah/kecamatan'
    }
  ],
  link: [
    {
      rel: 'canonical',
      href: 'https://nusakita.yuefii.site/data-wilayah/kecamatan'
    }
  ]
})
</script>
