  ...
  <div class="flex flex-1 flex-col p-4 2xl:max-w-6xl">
    ...
    <div class="p-4 mb-4 md:mb-6">
      ...
      <div class="bg-zinc-700 p-3 md:p-4 rounded-md overflow-x-auto">
        <code class="text-white text-sm md:text-base"
          ...
          http://localhost:1945/v2/kecamatan</code
        >
      </div>
    </div>
    ...
    <div class="p-4 mb-4 md:mb-6">
      ...
      <div class="bg-zinc-700 p-3 md:p-4 rounded-md overflow-x-auto">
        <code class="text-white text-sm md:text-base"
          ><span class="text-green-600">GET</span>
          http://localhost:1945/v2/{kodeKabKota}/kecamatan</code
        >
      </div>
    ...
    <div class="p-4 mb-4 md:mb-6">
      ...
      <p class="text-gray-600 text-sm md:text-base">
        ...
        kabupaten/kota tertentu. Response akan menampilkan data dengan paginasi
    ...
    <div class="bg-white p-4 mb-4 md:mb-6">
      ...
      <div class="space-y-3 md:space-y-4">
        <div v-for="(example, index) in examples" :key="index">
          <p
            class="text-gray-700 font-medium mb-1 md:mb-2 text-sm md:text-base"
          >
            {{ example.title }}
          </p>
      ...
      <div class="mb-3 md:mb-4">
        ...
        >
          <li class="mb-1">
            ...
            <ul class="list-disc pl-5 mt-1">
              <li class="mb-1">
                ...
                (integer) - Total seluruh kecamatan
              </li>
              <li class="mb-1">
          ...
          <li>
            ...
            <ul class="list-disc pl-5 mt-1">
              <li class="mb-1">
                <code class="bg-gray-300 px-1 rounded">kode</code> (string) -
                Kode unik kecamatan
              </li>
              <li class="mb-1">
                <code class="bg-gray-300 px-1 rounded">nama</code> (string) -
                Nama kecamatan
              </li>
              <li class="mb-1">
                <code class="bg-gray-300 px-1 rounded">kode_kab_kota</code>
                (string) - Kode kabupaten/kota induk
              </li>
              <li class="mb-1">
    ...
    <div class="bg-white p-4">
      ...
      <ul class="list-disc pl-5 text-gray-600 space-y-1 text-sm md:text-base">
        ...
        <li>
          Untuk endpoint berdasarkan kabupaten/kota, pastikan kode
          kabupaten/kota valid
        </li>
      </ul>
    </div>
  </div>
