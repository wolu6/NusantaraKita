  ...
  <div class="flex flex-1 flex-col p-4 2xl:max-w-6xl">
    ...
    <div class="p-4 mb-4 md:mb-6">
      ...
      <div class="bg-zinc-700 p-3 md:p-4 rounded-md overflow-x-auto">
        <code class="text-white text-sm md:text-base"
          ...
          http://localhost:1945/v2/kab-kota</code
        >
      </div>
    </div>
    ...
    <div class="p-4 mb-4 md:mb-6">
      ...
      <div class="bg-zinc-700 p-3 md:p-4 rounded-md overflow-x-auto">
        <code class="text-white text-sm md:text-base"
          ><span class="text-green-600">GET</span>
          http://localhost:1945/v2/{kodeProvinsi}/kab-kota</code
        >
      </div>
        ...
        >
          <li class="mb-1">
            ...
            <ul class="list-disc pl-5 mt-1">
              <li class="mb-1">
                ...
                (integer) - Total seluruh kabupaten/kota
              </li>
              <li class="mb-1">
          ...
          <li>
            ...
            <ul class="list-disc pl-5 mt-1">
              ...
              <li class="mb-1">
                <code class="bg-gray-300 px-1 rounded">kode_provinsi</code>
                (string) - Kode provinsi induk
              </li>
              <li class="mb-1">
